<?php
    ...
    function contar_menores_promedios_de($lista_estudiantes, $val, $isMenor){
        $valor = $val;
        $output = [];
        foreach ($lista_estudiantes as $value ) {
            
            if($isMenor) {
                if( calcularPromedio($value['calificaciones']) < $val ){
                        // echo "<br><br>";
                        // echo calcularPromedio($value['calificaciones']);
    ...
    echo "<br><br> Estudiantes que requieren Tutoria: ";
    print_r(contar_menores_promedios_de($estudiantes, 75, 1));
    echo "<br><br> Estudiantes de honor: ";
    print_r(contar_menores_promedios_de($estudiantes, 90, 0));
