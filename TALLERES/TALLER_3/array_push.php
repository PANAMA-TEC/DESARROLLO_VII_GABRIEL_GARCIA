...
<?php
    ...
    $misAmigos = ['wilfredo','wigu']; // Reemplaza esto con tu array de amigos
    array_push($misAmigos, "javett", "yul"); // Reemplaza las comillas vacías con los nombres de tus amigos
